...
| IMPLEMENTATION_ITERATION | in_progress (1/4) | Q5 human decision: edge-visibility toggle (walked-from-center / all-edges); default all-edges = TOP_LEVEL call → CALLOUT |

...
const BOUNDS_ENFORCED_OUTSIDE_THE_ENGINE: Readonly<Record<string, string>> = {
	...
	"globalDepths.namedDepthOut": "the depth accessor's own clamp — see linkDepthOut.",
	"globalDepths.namedDepthIn": "the depth accessor's own clamp — see linkDepthOut.",
	...
	"globalDepths.pinnedNamedDepthOut": "the depth accessor's own clamp — see linkDepthOut.",
	"globalDepths.pinnedNamedDepthIn": "the depth accessor's own clamp — see linkDepthOut.",

...
export class EngineDefaults {
	static depthSettings(): DepthSettings {
		...
		return {
			...
			namedDepthOut: depths.namedDepthOut.default,
			namedDepthIn: depths.namedDepthIn.default,
			...
			pinnedNamedDepthOut: depths.pinnedNamedDepthOut.default,
			pinnedNamedDepthIn: depths.pinnedNamedDepthIn.default,

 ...
 * shape: a central note linking two neighbours. This exercises the plain
 * {@link ElkLayoutRunner} (the force SEED); the full force pipeline (elk seed +
 * d3 refinement) is covered end-to-end in `D3ForceLayout.test.ts`.
 */

...
FAILING TEST (committed, it.fails — flip to it as acceptance): src/persistence/PerDocStore.test.ts, describe "PerDocStore on a case-insensitive filesystem", using a CaseInsensitiveFakeVaultFsPort.

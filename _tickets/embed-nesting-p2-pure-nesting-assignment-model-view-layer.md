...
- Candidates for containing node n: rendered nodes with an edge to n of kind embed|both.
...
- Cycles (decision Q3): assign in precedence order, refuse any assignment creating a cycle; refused pairs stay ordinary edges.

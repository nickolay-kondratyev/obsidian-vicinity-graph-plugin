...
FAILING TEST (committed, it.fails — flip to it as acceptance): src/view/edgeGeometry.test.ts, "WHEN the edge is shorter than the inset floor THEN the tip stays between the endpoints".
